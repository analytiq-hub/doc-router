...
describe('Container Component', function () {
  ...
  describe('Container component calculations when noDefaults Form Renderer Option', function () {
    ...
    it('Should set correct form data and make correct container component calculations when noDefaults Form Renderer Option is set', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var element, form, textField;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              element = document.createElement('div');
              _context2.next = 3;
              return _Formio["default"].createForm(element, formTemplate, {
                noDefaults: true
              });
            case 3:
              form = _context2.sent;
              textField = form.getComponent('textField');
            ...
            case 8:
              _powerAssert["default"].deepEqual(form._data.container, {
                textField: 'test',
    ...
    it('Should set correct form data and make correct container component calculations when noDefaults Form Renderer Option is not set', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var element, form, textField;
