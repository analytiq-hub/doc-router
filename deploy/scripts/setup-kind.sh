...
echo "   docker build -t analytiq-hub/doc-router-frontend:latest --target frontend ."
echo "   docker build -t analytiq-hub/doc-router-backend:latest --target backend ."
echo "   kind load docker-image analytiq-hub/doc-router-frontend:latest --name $CLUSTER_NAME"
echo "   kind load docker-image analytiq-hub/doc-router-backend:latest --name $CLUSTER_NAME"
echo ""
