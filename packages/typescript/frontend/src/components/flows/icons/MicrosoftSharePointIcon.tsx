...
/**
 * Microsoft SharePoint Fluent product mark (DocRouter SVG).
 * Rounded tile with “S” in front of three teal circles — matches official artwork geometry.
 */
export function MicrosoftSharePointIcon({
  className,
}: {
  className?: string;
}): React.ReactElement {
