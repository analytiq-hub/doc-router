      ...
      >
        ...
        <div className="flex-1 overflow-auto">
          <ReactDiffViewer
            ...
            splitView={true}
            leftTitle={`Version ${leftPrompt.prompt_version} (${formatLocalDate(leftPrompt.created_at)})`}
            rightTitle={`Version ${rightPrompt.prompt_version} (${formatLocalDate(rightPrompt.created_at)})`}
            showDiffOnly={false}
            useDarkTheme={false}
            styles={{
              variables: {
