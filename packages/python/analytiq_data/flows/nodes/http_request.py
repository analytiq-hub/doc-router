    ...
    parameter_schema: dict[str, Any] = {
        ...
        "properties": {
            ...
            "url": {
                ...
                "default": "",
                "x-display-group": "Request",
                "x-display-placeholder": "https://… or =expression",
            },
            "query_params": {
                "type": "array",
                "x-display-ui": "nameValueList",
                "x-display-group": "Request",
                "items": {
                    "type": "object",
                    "required": ["name", "value"],
            ...
            "body_mode": {
                ...
                "default": "none",
                "x-display-group": "Body",
            },
            "body_json": {
                "type": "string",
                "default": "",
                "x-display-ui": "textarea",
                "x-display-group": "Body",
            ...
            "body_params": {
                ...
                "x-display-ui": "nameValueList",
                "x-display-group": "Body",
                "x-display-showWhen": {"field": "body_mode", "in": ["json_keypair", "form_urlencoded"]},
                "items": {
                    "type": "object",
                    "required": ["name", "value"],
                    "properties": {
            ...
            "body_raw": {
                ...
                "x-display-ui": "textarea",
                "x-display-group": "Body",
                "x-display-showWhen": {"field": "body_mode", "equals": "raw"},
            },
            "body_content_type": {
                "type": "string",
                "default": "text/plain",
