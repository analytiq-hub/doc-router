"""Microsoft SharePoint poll trigger node (``flows.trigger.microsoft_sharepoint``)."""
...
from .poll_trigger import poll_microsoft_sharepoint_trigger
...
class FlowsMicrosoftSharePointTriggerNode:
    """Trigger for Microsoft SharePoint document library changes."""

    key = "flows.trigger.microsoft_sharepoint"
    label = "Microsoft SharePoint Trigger"
    description = "Trigger for Microsoft SharePoint API."
    category = "input"
    ...
    async def poll(
        ...
        return await poll_microsoft_sharepoint_trigger(context, node)
