"""
Integration tests for failed flow runs: ``error.stack`` and ``last_node_executed``.

Covers the worker path (``process_flow_run_msg`` → MongoDB) and
``GET .../executions/{id}`` (see ``docs/docrouter_fulltrace.md`` Phase 0).
"""
